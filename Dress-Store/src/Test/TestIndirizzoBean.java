...
IndirizzoBean indirizzo;
    ...
    @Before
	public void setUp() throws Exception {//viene eseguito prima dell'esecuzione di ogni test
	...
	@Test
	public void testSetId_Indirizzo() { //test metodo setId_indirizzo
		int id_indirizzo=1;
	...
	@Test
	public void testSetId_indirizzoInvalido() { //test su id non valido
	...
	@Test
	public void testSetNome(){    //test dei vari metodi set di indirizzoBean
		String nome="nome";
